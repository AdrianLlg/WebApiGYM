...
namespace WebAPIBusiness.Resources {
    ...
    internal class ScriptsGYMDB {
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a EXEC sp_fkeys &apos;{0}&apos;.
        /// </summary>
        ...
        ///SELECT disciplinaID FROM membresia_persona_disciplina WHERE personaID = &apos;1&apos; A [resto de la cadena truncado]&quot;;.
        /// </summary>
        ...
        ///INNER JOIN horarioM h ON [resto de la cadena truncado]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a SELECT p.nombres,p.apellidos,p.email,c.nombre as clase ,evt.fecha,
        ...
        ///(SELECT COUNT(*) FROM evento_persona INNER JOIN persona P2 ON evento_persona.personaID=P2.personaID WHERE p2.perso [resto de la cadena truncado]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a SELECT nombre as Sala ,COUNT(*)as cantidadEventos FROM evento
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a SELECT nombre as Disciplina ,COUNT(*)as CantidadEventos FROM evento
        ...
        ///  FROM evento evt
        ///  INNER JOIN evento_persona  ep ON evt [resto de la cadena truncado]&quot;;.
        /// </summary>
        ...
        ///FROM cronograma CR
        ///INNER JOIN horarioM HM ON  [resto de la cadena truncado]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a SELECT m.nombre as nombreMembresia, 
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a SELECT* FROM noticia nt
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a SELECT u.usuarioID,p.personaID,rolePID,nombres,apellidos,identificacion,u.email,u.password,telefono,edad,sexo,fechaNacimiento,fechaCreacion,estado
        ///  FROM persona p
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a SELECT estado as Estado,Count(*)as Cantidad
        ///FROM persona 
        ///GROUP BY estado
        ///HAVING COUNT(*) &gt; 0.
        /// </summary>
        ...
        ///  Where p.personaID=&apos;{0}&apos; and evt.fecha&gt;=&apos;{1}&apos; and ev [resto de la cadena truncado]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a SELECT Mes , Anio,COUNT(*) as Transacciones  FROM (SELECT (DATENAME(month,fechaTransaccion)) AS Mes,(YEAR(fechaTransaccion)) AS Anio FROM membresia_persona_pago as MPP WHERE YEAR(MPP.fechaTransaccion) = {0} AND MPP.estado=&apos;A&apos;)AS TABLA
        ///group by Mes,Anio
        ///HAVING count(*) &gt;0.
        /// </summary>
        ...
        /// <summary>
        ///   Busca una cadena traducida similar a SELECT nombre as Membresia,(precio*Cantidad)AS TotalVentas FROM(
