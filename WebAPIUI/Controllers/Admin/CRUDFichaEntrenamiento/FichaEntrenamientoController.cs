...
namespace WebAPIUI.Controllers
{
    ...
    public class FichaEntrenamientoController : BaseAPIController
    {
        ...
        /// </summary>
        private bool InsertarFichaEntrenamiento(string FechaCreacion, int fichaPersonaID, int ProfesorID, int DiciplinaID, string Observaciones)
        {
            ...
            try
            {
                response = bo.insertFichaEntrenamiento(FechaCreacion, fichaPersonaID, ProfesorID, DiciplinaID, Observaciones);
            }
        ...
        /// </summary>
        private bool ModificarFichaEntrenamiento(int fichaEntrenamientoID, string FechaCreacion, int fichaPersonaID, int ProfesorID, int DiciplinaID, string Observaciones)
        {
            FichaEntrenamientoBO bo = new FichaEntrenamientoBO();
            List<string> messages = new List<string>();
            bool response = false;
            ...
            try
            {
                response = bo.modifyFichaEntrenamiento(fichaEntrenamientoID,  FechaCreacion,  fichaPersonaID,  ProfesorID,  DiciplinaID,  Observaciones);
            }
            catch (ValidationAndMessageException FichaEntrenamientoException)
            {
                messages.Add(FichaEntrenamientoException.Message);
        ...
        public FichaEntrenamientoDataResponse Post(FichaEntrenamientoDataRequest dataRequest)
        {
            ...
            try
            {
                ...
                {
                    bool resp = InsertarFichaEntrenamiento( dataRequest.FechaCreacion, dataRequest.fichaPersonaID, dataRequest.ProfesorID, dataRequest.DiciplinaID, dataRequest.Observaciones);
                ...
                {
                    bool resp = ModificarFichaEntrenamiento(dataRequest.fichaEntrenamientoID, dataRequest.FechaCreacion, dataRequest.fichaPersonaID, dataRequest.ProfesorID, dataRequest.DiciplinaID, dataRequest.Observaciones);
