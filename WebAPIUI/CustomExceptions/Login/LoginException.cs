...
namespace WebAPIUI.CustomExceptions.Login
{
    /// <summary>
    ...
    public class LoginException : Exception
    {
        ...
        /// Tipo de error.
        /// </summary>
        public LoginResponseType Type { get; private set; }
        ...
        public LoginException(LoginResponseType type, string message)
            : base(message)
        {
            this.Type = type;
        }
        ...
        public LoginException(LoginResponseType type, IList<string> messageList)
